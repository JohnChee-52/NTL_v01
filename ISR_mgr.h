...
#include "ISR_Register.h"

extern "C"{ void helper_ISR(int iUsrID);}

//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class cl_isr_base{ //Abstract base class to force uniform interface for derived classes
public:
    virtual void exec_isr(int iUsrID) = 0; //ISR to be defined by derived class
};
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
class cl_isr_mgr{
public:
    typedef cl_isr_base* pcl_isr_t; //Ptr to isr base class

    cl_isr_mgr(); //ctor
    static void register_ISR(int iUsrID, pcl_isr_t pcl_UsrISR);
    static void dispatch_ISR(int iUsrID);

private:
    static pcl_isr_t apcl_VTable[iNo_of_ISRs]; //Table of ptrs to ISRs
